...
//		$linkPath = dirname($scriptPath, 2) . "/profileActivation/?profileActivationToken=$profileActivationToken";
		$linkPath = "https://" . $_SERVER["SERVER_NAME"] . dirname($scriptPath, 2) . "/profileActivation/?profileActivationToken=" . $profileActivationToken . "&companyId=" . $company->getCompanyId() . "&profileId=" . $profile->getProfileId();
